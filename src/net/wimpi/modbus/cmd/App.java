...
//        ReadInputRegistersRequest request = new ReadInputRegistersRequest(0, 4);
        ...
        ReadMultipleRegistersResponse result = (ReadMultipleRegistersResponse) transaction.getResponse();
